...
def main():
    ...
    nca_agent_info = sa.Table('nca_agent_info', meta,
        ...
        sa.Column('availiable', sa.String(attr.IP_LEN), nullable=False),
        sa.Column('status', sa.String(attr.IP_LEN), nullable=True),
    ...
    sp_policy_info = sa.Table('sp_policy_info', meta,
        sa.Column('id', sa.String(attr.UUID_LEN), primary_key=True,
                  nullable=False),
        sa.Column('tenant_id', sa.String(attr.NAME_MAX_LEN), nullable=False),
        sa.Column('sp_policy_id', sa.String(attr.NAME_MAX_LEN), nullable=True),
        sa.Column('src_type', sa.String(attr.UUID_LEN), nullable=False),
        sa.Column('src_logic', sa.String(attr.NAME_MAX_LEN), nullable=False),
        sa.Column('src_data1', sa.String(attr.NAME_MAX_LEN), nullable=False),
        sa.Column('src_data2', sa.String(attr.NAME_MAX_LEN), nullable=True),
        ...
        sa.Column('dst_type', sa.String(attr.NAME_MAX_LEN), nullable=False),
        sa.Column('dst_logic', sa.String(attr.NAME_MAX_LEN), nullable=False),
        sa.Column('dst_data1', sa.String(attr.NAME_MAX_LEN), nullable=False),
        sa.Column('dst_data2', sa.String(attr.NAME_MAX_LEN), nullable=True),
        sa.Column('operation_fro', sa.String(attr.NAME_MAX_LEN),
                  nullable=False),
        sa.Column('deleted_at', sa.DateTime(), nullable=True),
    ...
    region_user_info = sa.Table('region_user_info', meta,
        sa.Column('id', sa.String(attr.UUID_LEN), nullable=False,
                  primary_key=True),
        sa.Column('tenant_id', sa.String(attr.NAME_MAX_LEN), nullable=False),
        sa.Column('region_useruser_id', sa.String(attr.NAME_MAX_LEN),
                  nullable=True),
        sa.Column('name', sa.String(attr.NAME_MAX_LEN), nullable=False),
        sa.Column('region_id', sa.String(attr.NAME_MAX_LEN), nullable=False),
        sa.Column('type', sa.String(attr.NAME_MAX_LEN), nullable=False),
        sa.Column('data1', sa.String(attr.NAME_MAX_LEN), nullable=False),
        sa.Column('data2', sa.String(attr.NAME_MAX_LEN), nullable=True),
    ...
    region_info = sa.Table('region_info', meta,
        sa.Column('id', sa.String(attr.NAME_MAX_LEN), nullable=False,
                  primary_key=True),
        sa.Column('tenant_id', sa.String(attr.NAME_MAX_LEN), nullable=False),
        sa.Column('name', sa.String(attr.NAME_MAX_LEN), nullable=False),
        sa.Column('region_id', sa.String(attr.NAME_MAX_LEN), nullable=True),
    ...
    gmap_info = sa.Table('gmap_info', meta,
        ...
        sa.Column('tenant_id', sa.String(attr.NAME_MAX_LEN), nullable=False),
        sa.Column('name', sa.String(attr.NAME_MAX_LEN), nullable=False),
        sa.Column('enable', sa.String(attr.TTL_LEN), nullable=True),
        sa.Column('algorithm', sa.String(attr.NAME_MAX_LEN), nullable=True),
        sa.Column('last_resort_pool', sa.String(attr.NAME_MAX_LEN),
                  nullable=True),
        sa.Column('gpool_list', sa.String(attr.INPUT_MAX_LEN), nullable=True),
    ...
    gpool_info = sa.Table('gpool_info', meta,
        ...
        sa.Column('tenant_id', sa.String(attr.NAME_MAX_LEN), nullable=False),
        sa.Column('name', sa.String(attr.NAME_MAX_LEN), nullable=False),
        sa.Column('enable', sa.String(attr.TTL_LEN), nullable=False),
        sa.Column('ttl', sa.String(attr.TTL_LEN), nullable=False),
        sa.Column('max_addr_ret', sa.String(attr.TTL_LEN),
                  nullable=True),
        sa.Column('cname', sa.String(attr.NAME_MAX_LEN), nullable=True),
        sa.Column('first_algorithm', sa.String(attr.NAME_MAX_LEN),
                  nullable=True),
        sa.Column('second_algorithm', sa.String(attr.NAME_MAX_LEN),
                  nullable=True),
        ...
        sa.Column('gmember_list', sa.String(attr.NAME_MAX_LEN),
                  nullable=True),
    ...
    syngroup_info = sa.Table('syngroup_info', meta,
        ...
        sa.Column('tenant_id', sa.String(attr.NAME_MAX_LEN), nullable=False),
        sa.Column('name', sa.String(attr.NAME_MAX_LEN), nullable=False),
        sa.Column('gslb_zone_names', sa.String(attr.INPUT_MAX_LEN), nullable=True),
    ...
    gmember_info = sa.Table('gmember_info', meta,
        ...
        sa.Column('tenant_id', sa.String(attr.NAME_MAX_LEN), nullable=False),
        sa.Column('gslb_zone_name', sa.String(attr.NAME_MAX_LEN),
                  nullable=False),
        sa.Column('name', sa.String(attr.NAME_MAX_LEN),
                  nullable=False),
        sa.Column('ip', sa.String(attr.IP_LEN), nullable=False),
        sa.Column('port', sa.String(attr.FIVE_LEN), nullable=False),
        sa.Column('enable', sa.String(attr.FIVE_LEN), nullable=False),
        sa.Column('gmember_id', sa.String(attr.NAME_MAX_LEN), nullable=True),
    ...
    gslb_zone_info = sa.Table('gslb_zone_info', meta,
        sa.Column('id', sa.String(attr.UUID_LEN), nullable=False,
                  primary_key=True),
        sa.Column('name', sa.String(attr.NAME_MAX_LEN), nullable=False),
        sa.Column('enable', sa.String(attr.FIVE_LEN), nullable=True),
        sa.Column('devices', sa.String(attr.INPUT_MAX_LEN), nullable=False),
        sa.Column('syn_server', sa.String(attr.INPUT_MAX_LEN), nullable=False),
        sa.Column('gslb_zone_id', sa.String(attr.NAME_MAX_LEN),
                  nullable=True),
        sa.Column('tenant_id', sa.String(attr.NAME_MAX_LEN), nullable=False),
        sa.Column('operation_fro', sa.String(attr.NAME_MAX_LEN),
                  nullable=False),
    ...
    hm_template_info = sa.Table('hm_template_info', meta,
        ...
        sa.Column('tenant_id', sa.String(attr.NAME_MAX_LEN), nullable=False),
        sa.Column('name', sa.String(attr.NAME_MAX_LEN), nullable=False),
        sa.Column('types', sa.String(attr.IP_LEN), nullable=False),
        sa.Column('check_interval', sa.String(attr.FIVE_LEN),
                  nullable=False),
        sa.Column('timeout', sa.String(attr.FIVE_LEN), nullable=False),
        sa.Column('max_retries', sa.String(attr.FIVE_LEN), nullable=False),
        sa.Column('sendstring', sa.String(attr.INPUT_MAX_LEN), nullable=True),
        sa.Column('recvstring', sa.String(attr.INPUT_MAX_LEN), nullable=True),
        sa.Column('hm_template_id', sa.String(attr.NAME_MAX_LEN),
                  nullable=True),
        sa.Column('refcnt', sa.String(attr.TEN_LEN), nullable=True),
    ...
    tables = [dns_zone_info, nca_agent_info, nca_vres_info,
              ...
              gslb_zone_info, hm_template_info]
    for table in tables:
        try:
            if not table.exists():
                table.create()
